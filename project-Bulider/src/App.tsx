 ...
 {errors[input.name] && <ErrorMassage message={errors[input.name]} />}
   ...
   return ( 
    ...
    <div className=' container mx-auto'>
      <button onClick={openModal}  className=' bg-indigo-700 hover:bg-indigo-800  flex items-center justify-center w-full text-white mb-1 '> Build A New Product</button>
